...
public class webelement {
	...
	void test() {
		...
		driver.findElement(By.xpath("/html/body/div/div/div/form/div[4]/button")).click();		
		  ...
		  WebElement driver1 = driver.findElement(By.cssSelector("div.CouponCode--Modal--form--radios:nth-child(6) > p:nth-child(3) > input:nth-child(2)"));
		 driver1.click();
		  ...
		  customer.click();
		  System.out.println("Driver radio button is enable or not:" + driver1.isSelected());
		  System.out.println("Customer radio button is enable or not:" + customer.isSelected());
		  System.out.println("Customer radio button is enable or not:" + customer.isDisplayed());
